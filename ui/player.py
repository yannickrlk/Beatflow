...
class FooterPlayer(ctk.CTkFrame):
    ...
    def _build_ui(self):
        ...
        self.grid_columnconfigure(2, weight=0, minsize=130)  # Volume
        ...
        # Play/Pause button
        # Keyboard shortcut: Space key toggles play/pause (bound in app.py)
        ...
        # Add tooltip showing keyboard shortcut hint
        self._create_tooltip(self.play_btn, "Play/Pause [Space]")
